...
parser.add_argument('-filter', help='Filter string for LM get. See LM API docs.')
...
logging.basicConfig(level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(messages')
...
if args.filter:
    queryParams = '&'.join([queryParams, args.filter])
data         = ''
